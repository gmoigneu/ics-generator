		...
		<main class="wrapper">
			...
			<section class="container">
		        ...
		        <form action="/generate" method="post">
		        	...
		        	<input type="text" name="name" placeholder="My wonderful event" />

		        	<label for="name">Start date: </label>
		        	<input type="text" name="start" placeholder="<?php echo $startDate; ?>" />

		        	<label for="name">End date: </label>
		        	<input type="text" name="end" placeholder="<?php echo $endDate; ?>" />
		        	...
		        	<label for="name">Organizer email (optional): </label>
		        	<input type="text" name="organizer" placeholder="hello@example.com" />
